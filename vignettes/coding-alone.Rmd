...
The following table shows the percentage change in both rates, for each of
the five data sources, from Jan 2021 until Sep 2026.


Table: Percentage change in repo-creation rate and commit rate, by source, now vs. Jan 2021
