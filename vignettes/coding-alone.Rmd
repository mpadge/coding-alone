...
statistics are shown in the following two panels.
...
Both of these panels manifest two distinct regimes, separated either side of
late 2020, early 2021. The following table compares current values with those
in Jan 2021, showing the percentage decrease in overall coding activity.


Table: Commits per repo-month, by source, now vs. Jan 2021

|Source   | Jan 2021| Current| Relative change(%)|
|:--------|--------:|-------:|------------------:|
|JOSS     |     2.15|    0.80|               -63%|
|CRAN     |     0.51|    0.31|               -39%|
|npm      |     2.01|    2.00|                -1%|
|PyPI     |     1.01|    1.03|                 2%|
|rOpenSci |     0.18|    0.22|                23%|
