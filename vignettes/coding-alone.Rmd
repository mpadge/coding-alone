...
<img src="coding-alone-figures/commit-rate-plot-1.png" alt="Rates of creation of new repos (top panel, as relative monthly percentages) and of commits per month (bottom). All rates are 12-month trailing averages."  />
<p class="caption">Rates of creation of new repos (top panel, as relative monthly percentages) and of commits per month (bottom). All rates are 12-month trailing averages.</p>
</div>

The following table of percentage change in both rates from Jan 2021 shows that
rates of new repository creations have dropped consistently. (Respository
...
influences.) Repository maintenance, measured in terms of numbers of commits,
has also generally decreased (with the notable extreme outlier of rOpenSci),
although by relatively little for the two dominant systems of npm and PyPI.
...
## Finding 2: fewer outsiders, counted properly
