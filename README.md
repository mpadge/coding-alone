...
- `vignette ("coding-alone", package = "codingAlone")` - the main
  analysis on the demise of code communities.
- `vignette ("review-dividend", package = "codingAlone")` - additional
  analyses of the effect of software peer review on sustaining
